...
const sidebarItens = {
    ...
    'IconSettings': { icon: <IconSettings />, label: 'Configurações', destiny: '/settings' },
    'IconFileExport': { icon: <IconFileExport />, label: 'Gerar documentos', destiny: '/documents' },
    'IconDatabaseExport': { icon: <IconDatabaseExport />, label: 'Gerar relatórios', destiny: '/reports' },
    'IconUsers': { icon: <IconUsers />, label: 'Sindicalizados', destiny: '/Associates' },
    'IconArchive': { icon: <IconArchive />, label: 'Patrimônio', destiny: '/patrimony' },

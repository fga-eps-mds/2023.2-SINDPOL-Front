  ...
  const submitForm = async (associate: any) => {
    try {
      ...
      if (
        ...
        res.payload.response.data.detail
      ) {
      ...
      <Box id="home-page-box" sx={styles.box}>
          ...
          <Box>
            <Box id="modal-body" sx={styles.modalBox}>
              ...
              {selectedFile ? (
                ...
                <Text sx={styles.textImport}>
                  &nbsp;Escolha um arquivo csv ou solte-o aqui
                </Text>
              )}
            </Box>
            <GenericButton
        ...
        <Box>
          ...
          >
            ...
            >
              Assim que o processamento terminar os sindicalizados estarão
              listados na tela de sindicalizados
            </Text>

            <div style={{ maxHeight: "250px", overflowY: "auto" }}>
              {" "}
              {/* Defina a altura máxima e a rolagem vertical */}
              <table style={TABLE}>
                <thead>
                  <tr style={TABLE}>
